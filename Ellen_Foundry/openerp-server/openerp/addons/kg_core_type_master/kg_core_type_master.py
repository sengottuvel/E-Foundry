...
class kg_core_type_master(osv.osv):

	_name = "kg.core.type.master"
	_description = "Core Type"
	...
	def write(self, cr, uid, ids, vals, context=None):
		...
		return super(kg_core_type_master, self).write(cr, uid, ids, vals, context)	
