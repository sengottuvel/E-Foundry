...
class kg_painting_master(osv.osv):

	_name = "kg.painting.master"
	_description = "Painting Master"
	...
	def write(self, cr, uid, ids, vals, context=None):
		...
		return super(kg_painting_master, self).write(cr, uid, ids, vals, context)	
