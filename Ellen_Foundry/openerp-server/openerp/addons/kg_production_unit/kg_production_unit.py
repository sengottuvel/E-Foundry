...
class kg_production_unit(osv.osv):

	_name = "kg.production.unit"
	...
	_columns = {
		...
		'capacity': fields.float('Capacity/Day'),	
		...
		if rec.state == 'draft':
			if rec.capacity <=0:
				raise osv.except_osv(_('Warning !!'),
					_('Capacity must be greater than 0 !!'))
	...
	def write(self, cr, uid, ids, vals, context=None):
		...
		return super(kg_production_unit, self).write(cr, uid, ids, vals, context)	
