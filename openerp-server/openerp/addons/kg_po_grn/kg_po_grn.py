...
class kg_po_grn(osv.osv):
	...
	_columns = {
		...
		'dc_date':fields.date('DC Date', readonly=True, states={'item_load':[('readonly',False)],'draft':[('readonly',False)],'confirmed':[('readonly',False)]}),		
				...
				for order_line in order_lines:
					if order_line.pending_qty > 0 and order_line.line_state != 'cancel':
						po_grn_line_obj.create(cr, uid, {
							...
							'tot_price': order_line.pending_qty * order_line.price_unit,
