...
class product_template(osv.osv):
	...
	_columns = {
		...
		'uom_id': fields.many2one('product.uom', 'Store UOM', domain="[('state','=','approved')]" ,required=True, help="Default Unit of Measure used for all stock operation."),
		'uom_po_id': fields.many2one('product.uom', 'PO UOM', domain="[('state','=','approved')]" ,required=True, help="Default Unit of Measure used for purchase orders. It must be in the same category than the default unit of measure."),
